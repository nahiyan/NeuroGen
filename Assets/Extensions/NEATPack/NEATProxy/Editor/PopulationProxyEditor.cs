...
namespace NEAT
{
    ...
    public class PopulationProxyEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.LabelField("Max fitness: ", Target.GenomeProxies.Max(x => x.GenomeProperty.Fitness).ToString());
                EditorGUILayout.LabelField("Avg fitness: ", Target.GenomeProxies.Average(x => x.GenomeProperty.Fitness).ToString());
