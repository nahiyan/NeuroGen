...
namespace NEAT
{
    public class Species
    {
        ...
        public int GenerationsSinceFitnessImprovement { get; private set; } = 0;
        ...
        public void UpdateMaxFitness()
        {
            ...
            if (currentMaxFitness > MaxFitness)
            {
                ...
                GenerationsSinceFitnessImprovement = 0;
            }
            else
                GenerationsSinceFitnessImprovement++;
        }

        public bool DidntImproveInLastGenerations(NEATConfig config)
        {
            return GenerationsSinceFitnessImprovement >= config.maxStagnation;
        }
